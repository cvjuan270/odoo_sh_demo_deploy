...
class TgrRadiology(models.Model):
    _name = "tgr.radiology"
...
class LabTest(models.Model):
    ...
    consumable_line_ids = fields.One2many("hms.consumable.line", "radiology_test_id", string="Consumable Line")
    tgr_tat = fields.Char(string="Turnaround Time")
    subsequent_test_ids = fields.Many2many(
        "tgr.radiology.test", "tgr_radiology_test_rel", "test_id", "sub_test_id", "Subsequent Tests"
    )
