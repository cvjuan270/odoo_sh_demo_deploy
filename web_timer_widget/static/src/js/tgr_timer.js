...
class AcsTimerField extends Component {
    ...
    static props = {
        ...standardFieldProps,
        tgr_timer_start_field: String,
        tgr_timer_stop_field: String,
    ...
    get ongoing() {
        let timer_running;
        timer_running = false;
        if (this.props.record.data[this.props.tgr_timer_start_field]){
            timer_running = true;
        }
        if (this.props.record.data[this.props.tgr_timer_start_field] && this.props.record.data[this.props.tgr_timer_stop_field]){
            timer_running = false;
        }
...
export const acsTimerField = {
    ...
    extractProps: ({ attrs, options }) => ({
        tgr_timer_start_field: options.widget_start_field,
        tgr_timer_stop_field: options.widget_stop_field,
