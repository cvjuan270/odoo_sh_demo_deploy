...
class TGRAppointment(models.Model):
    ...
    lab_request_ids = fields.One2many('tgr.laboratory.request', 'appointment_id', string='Lab Requests')
    ...
    def action_lab_request(self):
        ...
        action['views'] = [(self.env.ref('tgr_laboratory.patient_laboratory_test_request_form').id, 'form')]
        return action
    ...
    def tgr_appointment_common_data(self, invoice_id):
        ...
        data += req_ids.tgr_common_invoice_laboratory_data(invoice_id)
        return data
...
class Treatment(models.Model):
    ...
    request_ids = fields.One2many('tgr.laboratory.request', 'treatment_id', string='Lab Requests')
