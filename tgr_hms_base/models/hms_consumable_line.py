...
class TGRAppointmentConsumable(models.Model):
    _name = "hms.consumable.line"
    _description = "List of Consumables"

    @api.depends('price_unit','qty')
    def tgr_get_total_price(self):
        for rec in self:
    ...
    subtotal = fields.Float(compute=tgr_get_total_price, string='Subtotal', readonly=True, store=True)
