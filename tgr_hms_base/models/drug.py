...
class Flavour(models.Model):
    ...
    _sql_constraints = [
        ('name_tgr_medi_flavour_uniq', 'unique (name)', 'The name of the Content must be unique !'),
    ]
...
class TGRActiveComp(models.Model):
    _name = 'active.comp'
...
class TGRDrugCompany(models.Model):
    _name = 'drug.company'
...
class TGRDrugRoute(models.Model):
    _name = 'drug.route'
