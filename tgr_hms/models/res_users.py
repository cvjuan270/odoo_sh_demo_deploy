...
class User(models.Model):
    ...
    tgr_signature = fields.Binary(related='physician_id.signature', string="Tgr Signature", readonly=False, related_sudo=False)
    tgr_medical_license = fields.Char(related='physician_id.medical_license', string="Tgr Medical License,", readonly=False, related_sudo=False)
    tgr_appointment_duration = fields.Float(related="physician_id.appointment_duration", string="Tgr Appointment Duration",readonly=False, related_sudo=False)
