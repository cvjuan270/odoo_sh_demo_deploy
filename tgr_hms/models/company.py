...
class ResCompany(models.Model):
    ...
    tgr_check_appo_payment = fields.Boolean(string="Check Appointment Payment Status before Accepting Request")
    ...
    tgr_prescription_qrcode = fields.Boolean(string="Print Authetication QrCode on Presctiprion", default=True)
    tgr_cancel_old_appointment = fields.Boolean(string='Cancel Old Appointment', default=True)
    tgr_auto_appo_confirmation_mail = fields.Boolean(string="Sent Appointment Confirmation Mail")
    tgr_appointment_planned_duration = fields.Float(string="Default Appointment Planned Duration", default=0.25)

    tgr_reminder_day = fields.Float(string="Reminder Days")
    tgr_reminder_hours = fields.Float(string="Reminder Hours", default=2)

    tgr_flag_days = fields.Integer(string="Warning Flag Days", help="Days to count cancelled appointment", default=365)
    tgr_flag_count_limit = fields.Integer(string="Count Limit for Flag", help="Configure number to show alert flag after couting that many cancelled appoitments", default=10)
