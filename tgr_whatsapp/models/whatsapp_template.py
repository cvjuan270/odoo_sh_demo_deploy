...
class whatsappTemplate(models.Model):
    _name = 'tgr.whatsapp.template'
    _description = 'whatsapp Template'

    def tgr_get_default_lang(self):
    ...
    footer_message_type =  fields.Selection(MESSAGE_TYPE, string='Footer Message Type')
    ...
    language_id = fields.Many2one('res.lang', 'Language', default=tgr_get_default_lang)
